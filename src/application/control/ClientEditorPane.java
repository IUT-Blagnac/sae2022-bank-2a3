...
public class ClientEditorPane {
	...
	/**
	 * Permet de generer la fenetre editeur du client
	...
	public ClientEditorPane(Stage _parentStage, DailyBankState _dbstate) {
		...
		try {
			FXMLLoader loader = new FXMLLoader(ClientsManagementController.class.getResource("clienteditorpane.fxml"));//Permet de recuperer et de charger la vue fxml
