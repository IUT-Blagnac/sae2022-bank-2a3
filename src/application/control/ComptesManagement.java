...
public class ComptesManagement {
	...
	/**
	 * Permet de generer la fenetre de manager les comptes du client
	...
	/**
	 * Permet de generer les operation du compte courant du client
	 * @param cpt le compte courant du client de type CompteCourant
	 */
	...
	/**
	 * Permet de creer un nouveau compte courant
	 * @return compte 
	 */
	...
	/**
	 * Permet de cree une liste des compte courant d'un client a partir des comptes du client
	 * @return listeCpt
	 */
