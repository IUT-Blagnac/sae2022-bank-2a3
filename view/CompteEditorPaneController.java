...
public class CompteEditorPaneController implements Initializable {
	...
	/**
	 * a la fermeture de la fenetre met a jour les infos
	 */
	...
	/**
	 * affiche les options disponible sur ce client
	 * 
	 * @param client client que l'on a choisi
	 * @param cpte compte courant
	 * @param mode
	...
	/**
	 * ferme la fenetre principale et met a null les modifications
	 */
	@FXML
	...
	/**
	 * effectue l'actio puis ferme la fenetre
	 */
	@FXML
	 ...
	 * 
	 * @return true si il n'y a pas de problème et false sinon
	 */
