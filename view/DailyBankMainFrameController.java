...
public class DailyBankMainFrameController implements Initializable {
	...
	/**
	 * Permet de creer le contexte de la fenetre et de l'état de la banque
	 * 
	...
	/**
	 * a la fermeture met bind les info
	 */
	...
	/**
	 * affiche l'aide pour utiliser l'application
	 */
	@FXML
	...
	/**
	 * permet a une personne de se connecter
	 */
	@FXML
	...
	/**
	 * permet a une personne de se déconnecter
	 */
	@FXML
	...
	/**
	 * vérifie que les infos rentrées soit correcte
	 */
	...
	/**
	 * permet de voir les options disponibles sur un client
	 */
	@FXML
	...
	/**
	 * permet de voir les options disponible sur les employés
	 */
	@FXML
	...
	/**
	 * permet de se dconnecter de la base de donnée
	 */
