...
public class ClientEditorPaneController implements Initializable {
	...
	/**
	 * a la fermeture de la fenetre: se ferme
	 */
	...
	/**
	 * affiche les options que l'on peut faire sur un client
	 * 
	 * @param client client que l'on veut regarder
	 * @param mode
	...
	/**
	 * ferme la fenetre principale et annule les changements
	 */
	@FXML
	...
	/**
	 * vérifie que les changements soient valides
	 * 
	 * @return true si il n'y a pas de problème false sinon
	 */
