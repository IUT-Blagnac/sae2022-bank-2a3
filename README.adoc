...
|         | Doc. Util. V2 |         |       https://github.com/IUT-Blagnac/sae2022-bank-2a3/blob/main/documentation_technique_v2.adoc    
|         | Doc. Tec. V2 |    |  https://github.com/IUT-Blagnac/sae2022-bank-2a3/blob/main/documentation_utilisateur_v2.adoc   
|         | Code V2     |                     |  https://github.com/IUT-Blagnac/sae2022-bank-2a3/blob/main/daily_bank_v2.zip 
|         | Recette V2  |   |
|         | `jar` projet |     |https://github.com/IUT-Blagnac/sae2022-bank-2a3/blob/main/daily_bank_v2.jar
